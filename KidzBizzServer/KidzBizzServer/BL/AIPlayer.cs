...
namespace KidzBizzServer.BL
{
    ...
    public class AIPlayer
    {
        ...
        {
            //מודל הסתברותי, ככל הנראה יקנה נכס גם אם אין לו כסף 
            //להגדיר מה זה הרבה כסף , מה זה הרבה נכסים, להגדיר יחס בין שניהם 
            // שיהיה קשר בין הכסף למול ההסתברות שאני אקנה דרך מודל סטטיסטי 
